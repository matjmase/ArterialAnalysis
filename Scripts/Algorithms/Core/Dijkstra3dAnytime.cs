...
public class Dijkstra3dAnytime : IIteratableProcess
{
    // checking delegate
    public delegate bool IsValidNeighborCheckFunc(PositionCoord3d from, PositionCoord3d to);
